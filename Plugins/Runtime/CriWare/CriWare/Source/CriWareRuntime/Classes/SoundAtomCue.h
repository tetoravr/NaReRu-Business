...
public:
	...
	/* キュー名 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Sound Atom Cue", meta = (ToolTip = "The Cue name."))
	FString CueName;

	/* ループ設定 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Sound Atom Cue", meta = (ToolTip = "Loop Setting. Inherited: Use Loop settings in Cue preset from SoundAtomCueSheet."))
	...
	struct FColor AudioOuterRadiusColor = FColor(255, 153, 0);

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Attenuation", meta = (ToolTip = "Audio Inner Radius Color."))
	struct FColor AudioInnerRadiusColor = FColor(216, 130, 0);
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Atom Cue Sheet", meta = (DisplayName = "Get Cue Info", ScriptName = "GetCueInfo"))
...
public:
	...
	bool IsTickable() const override { return bIsRequestingCueInfo; }
