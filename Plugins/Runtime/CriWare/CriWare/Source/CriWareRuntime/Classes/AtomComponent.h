...
struct FAtomAisacControlParam
{
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "AisacControl", meta = (ToolTip = "Value.", ClampMin = "0.0", ClampMax = "1.0"))
	float Value;
};
...
class CRIWARERUNTIME_API UAtomComponent : public USceneComponent
{
	...
	/* デフォルト値はfalseです。 */
	UPROPERTY(EditAnywhere, Category = "Atom", meta = (DisplayName = "Only 2D Sound"))
