...
criErr_Notify_TYPE FCriWareApi::criErr_Notify = ::criErr_Notify;
criErr_Notify1_TYPE FCriWareApi::criErr_Notify1 = ::criErr_Notify1;
criErr_Notify2_TYPE FCriWareApi::criErr_Notify2 = ::criErr_Notify2;
criErr_NotifyPrmArray_TYPE FCriWareApi::criErr_NotifyPrmArray = ::criErr_NotifyPrmArray;
criErr_NotifyGeneric_TYPE FCriWareApi::criErr_NotifyGeneric = ::criErr_NotifyGeneric;
criErr_NotifyErrorSimple_TYPE FCriWareApi::criErr_NotifyErrorSimple = ::criErr_NotifyErrorSimple;
criErr_NotifyWarningSimple_TYPE FCriWareApi::criErr_NotifyWarningSimple = ::criErr_NotifyWarningSimple;
criFs_CalculateWorkSizeForLibrary_TYPE FCriWareApi::criFs_CalculateWorkSizeForLibrary = ::criFs_CalculateWorkSizeForLibrary;
criFs_InitializeLibrary_TYPE FCriWareApi::criFs_InitializeLibrary = ::criFs_InitializeLibrary;
criFs_FinalizeLibrary_TYPE FCriWareApi::criFs_FinalizeLibrary = ::criFs_FinalizeLibrary;
...
criFs_ExecuteMain_TYPE FCriWareApi::criFs_ExecuteMain = ::criFs_ExecuteMain;
criFs_ExecuteFileAccess_TYPE FCriWareApi::criFs_ExecuteFileAccess = ::criFs_ExecuteFileAccess;
criFs_ExecuteDataDecompression_TYPE FCriWareApi::criFs_ExecuteDataDecompression = ::criFs_ExecuteDataDecompression;
criFs_SetOpenRetryMode_TYPE FCriWareApi::criFs_SetOpenRetryMode = ::criFs_SetOpenRetryMode;
criFs_SetReadRetryMode_TYPE FCriWareApi::criFs_SetReadRetryMode = ::criFs_SetReadRetryMode;
criFs_BeginGroup_TYPE FCriWareApi::criFs_BeginGroup = ::criFs_BeginGroup;
criFs_EndGroup_TYPE FCriWareApi::criFs_EndGroup = ::criFs_EndGroup;
criFs_GetNumUsedBinders_TYPE FCriWareApi::criFs_GetNumUsedBinders = ::criFs_GetNumUsedBinders;
criFs_GetNumUsedLoaders_TYPE FCriWareApi::criFs_GetNumUsedLoaders = ::criFs_GetNumUsedLoaders;
criFs_GetNumUsedGroupLoaders_TYPE FCriWareApi::criFs_GetNumUsedGroupLoaders = ::criFs_GetNumUsedGroupLoaders;
criFs_GetNumUsedStdioHandles_TYPE FCriWareApi::criFs_GetNumUsedStdioHandles = ::criFs_GetNumUsedStdioHandles;
criFs_GetNumUsedInstallers_TYPE FCriWareApi::criFs_GetNumUsedInstallers = ::criFs_GetNumUsedInstallers;
criFs_GetNumBinds_TYPE FCriWareApi::criFs_GetNumBinds = ::criFs_GetNumBinds;
criFs_GetNumOpenedFiles_TYPE FCriWareApi::criFs_GetNumOpenedFiles = ::criFs_GetNumOpenedFiles;
criFs_SetSelectIoCallback_TYPE FCriWareApi::criFs_SetSelectIoCallback = ::criFs_SetSelectIoCallback;
criFs_GetDefaultIoInterface_TYPE FCriWareApi::criFs_GetDefaultIoInterface = ::criFs_GetDefaultIoInterface;
criFs_SetReadDeviceEnabled_TYPE FCriWareApi::criFs_SetReadDeviceEnabled = ::criFs_SetReadDeviceEnabled;
criFs_GetDeviceInfo_TYPE FCriWareApi::criFs_GetDeviceInfo = ::criFs_GetDeviceInfo;
criFs_SetDeviceInfo_TYPE FCriWareApi::criFs_SetDeviceInfo = ::criFs_SetDeviceInfo;
criFs_AddressToPath_TYPE FCriWareApi::criFs_AddressToPath = ::criFs_AddressToPath;
criFs_SetMemoryFileSystemSyncCopyLimit_TYPE FCriWareApi::criFs_SetMemoryFileSystemSyncCopyLimit = ::criFs_SetMemoryFileSystemSyncCopyLimit;
criFs_SetLoadLimiterSize_TYPE FCriWareApi::criFs_SetLoadLimiterSize = ::criFs_SetLoadLimiterSize;
criFs_SetLoadLimiterUnit_TYPE FCriWareApi::criFs_SetLoadLimiterUnit = ::criFs_SetLoadLimiterUnit;
criFs_LimitNumReadRequest_TYPE FCriWareApi::criFs_LimitNumReadRequest = ::criFs_LimitNumReadRequest;
criFs_SetDefaultPathSeparator_TYPE FCriWareApi::criFs_SetDefaultPathSeparator = ::criFs_SetDefaultPathSeparator;
criFs_ControlFileIoMode_TYPE FCriWareApi::criFs_ControlFileIoMode = ::criFs_ControlFileIoMode;
criFs_SetFileAccessThreadStackSize_TYPE FCriWareApi::criFs_SetFileAccessThreadStackSize = ::criFs_SetFileAccessThreadStackSize;
criFsBinder_SetUserHeapFunc_TYPE FCriWareApi::criFsBinder_SetUserHeapFunc = ::criFsBinder_SetUserHeapFunc;
...
criFsBinder_GetWorkSizeForBindCpk_TYPE FCriWareApi::criFsBinder_GetWorkSizeForBindCpk = ::criFsBinder_GetWorkSizeForBindCpk;
criFsBinder_AnalyzeWorkSizeForBindCpk_TYPE FCriWareApi::criFsBinder_AnalyzeWorkSizeForBindCpk = ::criFsBinder_AnalyzeWorkSizeForBindCpk;
criFsBinder_CalculateWorkSizeForBindCpk_TYPE FCriWareApi::criFsBinder_CalculateWorkSizeForBindCpk = ::criFsBinder_CalculateWorkSizeForBindCpk;
criFsBinder_GetWorkSizeForBindFile_TYPE FCriWareApi::criFsBinder_GetWorkSizeForBindFile = ::criFsBinder_GetWorkSizeForBindFile;
criFsBinder_GetWorkSizeForBindFiles_TYPE FCriWareApi::criFsBinder_GetWorkSizeForBindFiles = ::criFsBinder_GetWorkSizeForBindFiles;
criFsBinder_GetWorkSizeForBindFileSection_TYPE FCriWareApi::criFsBinder_GetWorkSizeForBindFileSection = ::criFsBinder_GetWorkSizeForBindFileSection;
criFsBinder_GetWorkSizeForBindDirectory_TYPE FCriWareApi::criFsBinder_GetWorkSizeForBindDirectory = ::criFsBinder_GetWorkSizeForBindDirectory;
criFsBinder_BindCpk_TYPE FCriWareApi::criFsBinder_BindCpk = ::criFsBinder_BindCpk;
criFsBinder_BindFile_TYPE FCriWareApi::criFsBinder_BindFile = ::criFsBinder_BindFile;
criFsBinder_BindFiles_TYPE FCriWareApi::criFsBinder_BindFiles = ::criFsBinder_BindFiles;
criFsBinder_BindFileSection_TYPE FCriWareApi::criFsBinder_BindFileSection = ::criFsBinder_BindFileSection;
criFsBinder_BindDirectory_TYPE FCriWareApi::criFsBinder_BindDirectory = ::criFsBinder_BindDirectory;
criFsBinder_Unbind_TYPE FCriWareApi::criFsBinder_Unbind = ::criFsBinder_Unbind;
criFsBinder_UnbindAsync_TYPE FCriWareApi::criFsBinder_UnbindAsync = ::criFsBinder_UnbindAsync;
criFsBinder_CleanImplicitUnbindList_TYPE FCriWareApi::criFsBinder_CleanImplicitUnbindList = ::criFsBinder_CleanImplicitUnbindList;
criFsBinder_GetStatus_TYPE FCriWareApi::criFsBinder_GetStatus = ::criFsBinder_GetStatus;
criFsBinder_Find_TYPE FCriWareApi::criFsBinder_Find = ::criFsBinder_Find;
criFsBinder_FindById_TYPE FCriWareApi::criFsBinder_FindById = ::criFsBinder_FindById;
criFsBinder_GetHandle_TYPE FCriWareApi::criFsBinder_GetHandle = ::criFsBinder_GetHandle;
criFsBinder_GetFileSize_TYPE FCriWareApi::criFsBinder_GetFileSize = ::criFsBinder_GetFileSize;
criFsBinder_GetFileSizeById_TYPE FCriWareApi::criFsBinder_GetFileSizeById = ::criFsBinder_GetFileSizeById;
criFsBinder_GetPriority_TYPE FCriWareApi::criFsBinder_GetPriority = ::criFsBinder_GetPriority;
criFsBinder_SetPriority_TYPE FCriWareApi::criFsBinder_SetPriority = ::criFsBinder_SetPriority;
criFsBinder_SetCurrentDirectory_TYPE FCriWareApi::criFsBinder_SetCurrentDirectory = ::criFsBinder_SetCurrentDirectory;
criFsBinder_GetContentsFileInfoById_TYPE FCriWareApi::criFsBinder_GetContentsFileInfoById = ::criFsBinder_GetContentsFileInfoById;
criFsBinder_GetContentsFileInfoByIndex_TYPE FCriWareApi::criFsBinder_GetContentsFileInfoByIndex = ::criFsBinder_GetContentsFileInfoByIndex;
criFsBinder_GetContentsFileUserStringById_TYPE FCriWareApi::criFsBinder_GetContentsFileUserStringById = ::criFsBinder_GetContentsFileUserStringById;
criFsBinder_GetBinderIdInfo_TYPE FCriWareApi::criFsBinder_GetBinderIdInfo = ::criFsBinder_GetBinderIdInfo;
criFsBinder_GetNumberOfGroupFiles_TYPE FCriWareApi::criFsBinder_GetNumberOfGroupFiles = ::criFsBinder_GetNumberOfGroupFiles;
criFsBinder_GetTotalGroupDataSize_TYPE FCriWareApi::criFsBinder_GetTotalGroupDataSize = ::criFsBinder_GetTotalGroupDataSize;
criFsBinder_GetWorkSizeForCpkIdAccessTable_TYPE FCriWareApi::criFsBinder_GetWorkSizeForCpkIdAccessTable = ::criFsBinder_GetWorkSizeForCpkIdAccessTable;
criFsBinder_SetupCpkIdAccessTable_TYPE FCriWareApi::criFsBinder_SetupCpkIdAccessTable = ::criFsBinder_SetupCpkIdAccessTable;
criFsBinder_CloseFile_TYPE FCriWareApi::criFsBinder_CloseFile = ::criFsBinder_CloseFile;
criFsBinder_ReopenFile_TYPE FCriWareApi::criFsBinder_ReopenFile = ::criFsBinder_ReopenFile;
criFsBinder_CloseFileAsync_TYPE FCriWareApi::criFsBinder_CloseFileAsync = ::criFsBinder_CloseFileAsync;
criFsBinder_ReopenFileAsync_TYPE FCriWareApi::criFsBinder_ReopenFileAsync = ::criFsBinder_ReopenFileAsync;
criFsBinder_CompleteAsyncFileReopen_TYPE FCriWareApi::criFsBinder_CompleteAsyncFileReopen = ::criFsBinder_CompleteAsyncFileReopen;
criFsBinder_SetPathSeparatorForBindFiles_TYPE FCriWareApi::criFsBinder_SetPathSeparatorForBindFiles = ::criFsBinder_SetPathSeparatorForBindFiles;
criFsLoader_Create_TYPE FCriWareApi::criFsLoader_Create = ::criFsLoader_Create;
criFsLoader_Destroy_TYPE FCriWareApi::criFsLoader_Destroy = ::criFsLoader_Destroy;
criFsLoader_SetLoadEndCallback_TYPE FCriWareApi::criFsLoader_SetLoadEndCallback = ::criFsLoader_SetLoadEndCallback;
criFsLoader_SetInplaceDecryptionCbFunc_TYPE FCriWareApi::criFsLoader_SetInplaceDecryptionCbFunc = ::criFsLoader_SetInplaceDecryptionCbFunc;
criFsLoader_Load_TYPE FCriWareApi::criFsLoader_Load = ::criFsLoader_Load;
criFsLoader_LoadById_TYPE FCriWareApi::criFsLoader_LoadById = ::criFsLoader_LoadById;
criFsLoader_LoadWithoutDecompression_TYPE FCriWareApi::criFsLoader_LoadWithoutDecompression = ::criFsLoader_LoadWithoutDecompression;
criFsLoader_LoadWithoutDecompressionById_TYPE FCriWareApi::criFsLoader_LoadWithoutDecompressionById = ::criFsLoader_LoadWithoutDecompressionById;
criFsLoader_DecompressData_TYPE FCriWareApi::criFsLoader_DecompressData = ::criFsLoader_DecompressData;
criFsLoader_Stop_TYPE FCriWareApi::criFsLoader_Stop = ::criFsLoader_Stop;
criFsLoader_GetStatus_TYPE FCriWareApi::criFsLoader_GetStatus = ::criFsLoader_GetStatus;
criFsLoader_GetIoError_TYPE FCriWareApi::criFsLoader_GetIoError = ::criFsLoader_GetIoError;
criFsLoader_GetLoadSize_TYPE FCriWareApi::criFsLoader_GetLoadSize = ::criFsLoader_GetLoadSize;
criFsLoader_GetProgress_TYPE FCriWareApi::criFsLoader_GetProgress = ::criFsLoader_GetProgress;
criFsLoader_GetPriority_TYPE FCriWareApi::criFsLoader_GetPriority = ::criFsLoader_GetPriority;
criFsLoader_SetPriority_TYPE FCriWareApi::criFsLoader_SetPriority = ::criFsLoader_SetPriority;
criFsLoader_SetReadUnitSize_TYPE FCriWareApi::criFsLoader_SetReadUnitSize = ::criFsLoader_SetReadUnitSize;
criFsLoader_SetLoadLimiter_TYPE FCriWareApi::criFsLoader_SetLoadLimiter = ::criFsLoader_SetLoadLimiter;
criFsGroupLoader_Create_TYPE FCriWareApi::criFsGroupLoader_Create = ::criFsGroupLoader_Create;
criFsGroupLoader_CreateFromBinderHn_TYPE FCriWareApi::criFsGroupLoader_CreateFromBinderHn = ::criFsGroupLoader_CreateFromBinderHn;
criFsGroupLoader_Destroy_TYPE FCriWareApi::criFsGroupLoader_Destroy = ::criFsGroupLoader_Destroy;
criFsGroupLoader_SetLoadStartCallback_TYPE FCriWareApi::criFsGroupLoader_SetLoadStartCallback = ::criFsGroupLoader_SetLoadStartCallback;
criFsGroupLoader_GetNumberOfGroupFiles_TYPE FCriWareApi::criFsGroupLoader_GetNumberOfGroupFiles = ::criFsGroupLoader_GetNumberOfGroupFiles;
criFsGroupLoader_GetTotalGroupDataSize_TYPE FCriWareApi::criFsGroupLoader_GetTotalGroupDataSize = ::criFsGroupLoader_GetTotalGroupDataSize;
criFsGroupLoader_GetGroupFileInfos_TYPE FCriWareApi::criFsGroupLoader_GetGroupFileInfos = ::criFsGroupLoader_GetGroupFileInfos;
criFsGroupLoader_LoadBulk_TYPE FCriWareApi::criFsGroupLoader_LoadBulk = ::criFsGroupLoader_LoadBulk;
criFsGroupLoader_Stop_TYPE FCriWareApi::criFsGroupLoader_Stop = ::criFsGroupLoader_Stop;
criFsGroupLoader_GetStatus_TYPE FCriWareApi::criFsGroupLoader_GetStatus = ::criFsGroupLoader_GetStatus;
criFsGroupLoader_GetLoadedFiles_TYPE FCriWareApi::criFsGroupLoader_GetLoadedFiles = ::criFsGroupLoader_GetLoadedFiles;
criFsGroupLoader_IsLoaded_TYPE FCriWareApi::criFsGroupLoader_IsLoaded = ::criFsGroupLoader_IsLoaded;
criFsGroupLoader_GetGroupFileInfoIndex_TYPE FCriWareApi::criFsGroupLoader_GetGroupFileInfoIndex = ::criFsGroupLoader_GetGroupFileInfoIndex;
criFsGroupLoader_GetGroupFileInfoIndexById_TYPE FCriWareApi::criFsGroupLoader_GetGroupFileInfoIndexById = ::criFsGroupLoader_GetGroupFileInfoIndexById;
criFsGroupLoader_GetGroupFileInfo_TYPE FCriWareApi::criFsGroupLoader_GetGroupFileInfo = ::criFsGroupLoader_GetGroupFileInfo;
criFsGroupLoader_GetGroupFileInfoById_TYPE FCriWareApi::criFsGroupLoader_GetGroupFileInfoById = ::criFsGroupLoader_GetGroupFileInfoById;
criFsGroupLoader_GetGroupName_TYPE FCriWareApi::criFsGroupLoader_GetGroupName = ::criFsGroupLoader_GetGroupName;
criFsGroupLoader_GetAttributeName_TYPE FCriWareApi::criFsGroupLoader_GetAttributeName = ::criFsGroupLoader_GetAttributeName;
criFsGroupLoader_GetLoaderPriority_TYPE FCriWareApi::criFsGroupLoader_GetLoaderPriority = ::criFsGroupLoader_GetLoaderPriority;
criFsGroupLoader_SetLoaderPriority_TYPE FCriWareApi::criFsGroupLoader_SetLoaderPriority = ::criFsGroupLoader_SetLoaderPriority;
criFsGroupLoader_SetReadUnitSize_TYPE FCriWareApi::criFsGroupLoader_SetReadUnitSize = ::criFsGroupLoader_SetReadUnitSize;
criFsGroupLoader_SetLoadLimiter_TYPE FCriWareApi::criFsGroupLoader_SetLoadLimiter = ::criFsGroupLoader_SetLoadLimiter;
criFsGroupLoader_LimitNumPreparingFiles_TYPE FCriWareApi::criFsGroupLoader_LimitNumPreparingFiles = ::criFsGroupLoader_LimitNumPreparingFiles;
criFsGroupLoader_GetGroupFileInfoStartOffset_TYPE FCriWareApi::criFsGroupLoader_GetGroupFileInfoStartOffset = ::criFsGroupLoader_GetGroupFileInfoStartOffset;
criFsGroupLoader_SetUseLoadedFlag_TYPE FCriWareApi::criFsGroupLoader_SetUseLoadedFlag = ::criFsGroupLoader_SetUseLoadedFlag;
...
criFsStdio_TellFileOffset_TYPE FCriWareApi::criFsStdio_TellFileOffset = ::criFsStdio_TellFileOffset;
criFsStdio_SeekFile_TYPE FCriWareApi::criFsStdio_SeekFile = ::criFsStdio_SeekFile;
criFsStdio_SetInterstageBuffer_TYPE FCriWareApi::criFsStdio_SetInterstageBuffer = ::criFsStdio_SetInterstageBuffer;
criFsStdio_ReadFile_TYPE FCriWareApi::criFsStdio_ReadFile = ::criFsStdio_ReadFile;
criFsStdio_WriteFile_TYPE FCriWareApi::criFsStdio_WriteFile = ::criFsStdio_WriteFile;
criFsStdio_SetReadPriority_TYPE FCriWareApi::criFsStdio_SetReadPriority = ::criFsStdio_SetReadPriority;
criFsStdio_RemoveFile_TYPE FCriWareApi::criFsStdio_RemoveFile = ::criFsStdio_RemoveFile;
...
criAtom_SetAdx1KeyString_TYPE FCriWareApi::criAtom_SetAdx1KeyString = ::criAtom_SetAdx1KeyString;
...
criAtomDecrypter_CalculateWorkSize_TYPE FCriWareApi::criAtomDecrypter_CalculateWorkSize = ::criAtomDecrypter_CalculateWorkSize;
criAtomDecrypter_Create_TYPE FCriWareApi::criAtomDecrypter_Create = ::criAtomDecrypter_Create;
criAtomDecrypter_Destroy_TYPE FCriWareApi::criAtomDecrypter_Destroy = ::criAtomDecrypter_Destroy;
...
criAtomPlayer_BreakLoop_TYPE FCriWareApi::criAtomPlayer_BreakLoop = ::criAtomPlayer_BreakLoop;
criAtomPlayer_SetDataEndCallback_TYPE FCriWareApi::criAtomPlayer_SetDataEndCallback = ::criAtomPlayer_SetDataEndCallback;
...
criAtomExAcb_Decrypt_TYPE FCriWareApi::criAtomExAcb_Decrypt = ::criAtomExAcb_Decrypt;
...
criAtomExStreamingCache_LoadWaveformByIdAsync_TYPE FCriWareApi::criAtomExStreamingCache_LoadWaveformByIdAsync = ::criAtomExStreamingCache_LoadWaveformByIdAsync;
criAtomExStreamingCache_LoadWaveformByNameAsync_TYPE FCriWareApi::criAtomExStreamingCache_LoadWaveformByNameAsync = ::criAtomExStreamingCache_LoadWaveformByNameAsync;
...
criAtomExHcaMx_SetBusSendLevel_TYPE FCriWareApi::criAtomExHcaMx_SetBusSendLevel = ::criAtomExHcaMx_SetBusSendLevel;
...
criMana_GetVersionNumber_TYPE FCriWareApi::criMana_GetVersionNumber = ::criMana_GetVersionNumber;
criMana_GetLibraryVersionString_TYPE FCriWareApi::criMana_GetLibraryVersionString = ::criMana_GetLibraryVersionString;
criMana_SetUserAllocator_TYPE FCriWareApi::criMana_SetUserAllocator = ::criMana_SetUserAllocator;
criMana_CalculateLibWorkSize_TYPE FCriWareApi::criMana_CalculateLibWorkSize = ::criMana_CalculateLibWorkSize;
criMana_Initialize_TYPE FCriWareApi::criMana_Initialize = ::criMana_Initialize;
criMana_InitializeFrameARGB32_TYPE FCriWareApi::criMana_InitializeFrameARGB32 = ::criMana_InitializeFrameARGB32;
criMana_Finalize_TYPE FCriWareApi::criMana_Finalize = ::criMana_Finalize;
criMana_IsInitialized_TYPE FCriWareApi::criMana_IsInitialized = ::criMana_IsInitialized;
criMana_ExecuteMain_TYPE FCriWareApi::criMana_ExecuteMain = ::criMana_ExecuteMain;
criMana_SyncMasterTimer_TYPE FCriWareApi::criMana_SyncMasterTimer = ::criMana_SyncMasterTimer;
criMana_AdvanceManualTimer_TYPE FCriWareApi::criMana_AdvanceManualTimer = ::criMana_AdvanceManualTimer;
criMana_ExecuteVideoProcess_TYPE FCriWareApi::criMana_ExecuteVideoProcess = ::criMana_ExecuteVideoProcess;
criMana_SetDecodeSkipFlag_TYPE FCriWareApi::criMana_SetDecodeSkipFlag = ::criMana_SetDecodeSkipFlag;
criManaPlayer_CalculateHandleWorkSize_TYPE FCriWareApi::criManaPlayer_CalculateHandleWorkSize = ::criManaPlayer_CalculateHandleWorkSize;
criManaPlayer_CalculateHandleWorkSizeWithConfig_TYPE FCriWareApi::criManaPlayer_CalculateHandleWorkSizeWithConfig = ::criManaPlayer_CalculateHandleWorkSizeWithConfig;
criManaPlayer_Create_TYPE FCriWareApi::criManaPlayer_Create = ::criManaPlayer_Create;
criManaPlayer_CreateWithConfig_TYPE FCriWareApi::criManaPlayer_CreateWithConfig = ::criManaPlayer_CreateWithConfig;
criManaPlayer_Destroy_TYPE FCriWareApi::criManaPlayer_Destroy = ::criManaPlayer_Destroy;
criManaPlayer_SetMetaDataWorkAllocator_TYPE FCriWareApi::criManaPlayer_SetMetaDataWorkAllocator = ::criManaPlayer_SetMetaDataWorkAllocator;
criManaPlayer_GetPlaybackWorkParam_TYPE FCriWareApi::criManaPlayer_GetPlaybackWorkParam = ::criManaPlayer_GetPlaybackWorkParam;
criManaPlayer_CalculatePlaybackWorkSize_TYPE FCriWareApi::criManaPlayer_CalculatePlaybackWorkSize = ::criManaPlayer_CalculatePlaybackWorkSize;
criManaPlayer_SetPlaybackWork_TYPE FCriWareApi::criManaPlayer_SetPlaybackWork = ::criManaPlayer_SetPlaybackWork;
criManaPlayer_FreePlaybackWork_TYPE FCriWareApi::criManaPlayer_FreePlaybackWork = ::criManaPlayer_FreePlaybackWork;
criManaPlayer_GetStatus_TYPE FCriWareApi::criManaPlayer_GetStatus = ::criManaPlayer_GetStatus;
criManaPlayer_ExecuteMain_TYPE FCriWareApi::criManaPlayer_ExecuteMain = ::criManaPlayer_ExecuteMain;
criManaPlayer_SyncMasterTimer_TYPE FCriWareApi::criManaPlayer_SyncMasterTimer = ::criManaPlayer_SyncMasterTimer;
criManaPlayer_SetMasterTimerType_TYPE FCriWareApi::criManaPlayer_SetMasterTimerType = ::criManaPlayer_SetMasterTimerType;
criManaPlayer_GetMasterTimerType_TYPE FCriWareApi::criManaPlayer_GetMasterTimerType = ::criManaPlayer_GetMasterTimerType;
criManaPlayer_SetUserTime_TYPE FCriWareApi::criManaPlayer_SetUserTime = ::criManaPlayer_SetUserTime;
criManaPlayer_SetManualTimerUnit_TYPE FCriWareApi::criManaPlayer_SetManualTimerUnit = ::criManaPlayer_SetManualTimerUnit;
criManaPlayer_AdvanceManualTimer_TYPE FCriWareApi::criManaPlayer_AdvanceManualTimer = ::criManaPlayer_AdvanceManualTimer;
criManaPlayer_ExecuteVideoProcess_TYPE FCriWareApi::criManaPlayer_ExecuteVideoProcess = ::criManaPlayer_ExecuteVideoProcess;
criManaPlayer_SetFile_TYPE FCriWareApi::criManaPlayer_SetFile = ::criManaPlayer_SetFile;
criManaPlayer_SetData_TYPE FCriWareApi::criManaPlayer_SetData = ::criManaPlayer_SetData;
criManaPlayer_SetContentId_TYPE FCriWareApi::criManaPlayer_SetContentId = ::criManaPlayer_SetContentId;
criManaPlayer_SetFileRange_TYPE FCriWareApi::criManaPlayer_SetFileRange = ::criManaPlayer_SetFileRange;
criManaPlayer_SetPreviousDataAgain_TYPE FCriWareApi::criManaPlayer_SetPreviousDataAgain = ::criManaPlayer_SetPreviousDataAgain;
criManaPlayer_GetMovieInfo_TYPE FCriWareApi::criManaPlayer_GetMovieInfo = ::criManaPlayer_GetMovieInfo;
criManaPlayer_DecodeHeader_TYPE FCriWareApi::criManaPlayer_DecodeHeader = ::criManaPlayer_DecodeHeader;
criManaPlayer_Prepare_TYPE FCriWareApi::criManaPlayer_Prepare = ::criManaPlayer_Prepare;
criManaPlayer_Start_TYPE FCriWareApi::criManaPlayer_Start = ::criManaPlayer_Start;
criManaPlayer_Stop_TYPE FCriWareApi::criManaPlayer_Stop = ::criManaPlayer_Stop;
criManaPlayer_StopAndWaitCompletion_TYPE FCriWareApi::criManaPlayer_StopAndWaitCompletion = ::criManaPlayer_StopAndWaitCompletion;
criManaPlayer_Pause_TYPE FCriWareApi::criManaPlayer_Pause = ::criManaPlayer_Pause;
criManaPlayer_IsPaused_TYPE FCriWareApi::criManaPlayer_IsPaused = ::criManaPlayer_IsPaused;
criManaPlayer_Loop_TYPE FCriWareApi::criManaPlayer_Loop = ::criManaPlayer_Loop;
criManaPlayer_GetTime_TYPE FCriWareApi::criManaPlayer_GetTime = ::criManaPlayer_GetTime;
criManaPlayer_GetInputBufferSize_TYPE FCriWareApi::criManaPlayer_GetInputBufferSize = ::criManaPlayer_GetInputBufferSize;
criManaPlayer_GetInputBufferRemainSize_TYPE FCriWareApi::criManaPlayer_GetInputBufferRemainSize = ::criManaPlayer_GetInputBufferRemainSize;
criManaPlayer_SetNumberOfFramePools_TYPE FCriWareApi::criManaPlayer_SetNumberOfFramePools = ::criManaPlayer_SetNumberOfFramePools;
criManaPlayer_SetBufferingTime_TYPE FCriWareApi::criManaPlayer_SetBufferingTime = ::criManaPlayer_SetBufferingTime;
criManaPlayer_SetMinBufferSize_TYPE FCriWareApi::criManaPlayer_SetMinBufferSize = ::criManaPlayer_SetMinBufferSize;
criManaPlayer_SetFileStreamingFlag_TYPE FCriWareApi::criManaPlayer_SetFileStreamingFlag = ::criManaPlayer_SetFileStreamingFlag;
criManaPlayer_SetMaxMovieSize_TYPE FCriWareApi::criManaPlayer_SetMaxMovieSize = ::criManaPlayer_SetMaxMovieSize;
criManaPlayer_SetMaxPictureDataSize_TYPE FCriWareApi::criManaPlayer_SetMaxPictureDataSize = ::criManaPlayer_SetMaxPictureDataSize;
criManaPlayer_SetAudioTrack_TYPE FCriWareApi::criManaPlayer_SetAudioTrack = ::criManaPlayer_SetAudioTrack;
criManaPlayer_SetSubAudioTrack_TYPE FCriWareApi::criManaPlayer_SetSubAudioTrack = ::criManaPlayer_SetSubAudioTrack;
criManaPlayer_SetExtraAudioTrack_TYPE FCriWareApi::criManaPlayer_SetExtraAudioTrack = ::criManaPlayer_SetExtraAudioTrack;
criManaPlayer_SetVolume_TYPE FCriWareApi::criManaPlayer_SetVolume = ::criManaPlayer_SetVolume;
criManaPlayer_GetVolume_TYPE FCriWareApi::criManaPlayer_GetVolume = ::criManaPlayer_GetVolume;
criManaPlayer_GetAtomExPlayerByTrackId_TYPE FCriWareApi::criManaPlayer_GetAtomExPlayerByTrackId = ::criManaPlayer_GetAtomExPlayerByTrackId;
criManaPlayer_SetSubAudioVolume_TYPE FCriWareApi::criManaPlayer_SetSubAudioVolume = ::criManaPlayer_SetSubAudioVolume;
criManaPlayer_GetSubAudioVolume_TYPE FCriWareApi::criManaPlayer_GetSubAudioVolume = ::criManaPlayer_GetSubAudioVolume;
criManaPlayer_SetExtraAudioVolume_TYPE FCriWareApi::criManaPlayer_SetExtraAudioVolume = ::criManaPlayer_SetExtraAudioVolume;
criManaPlayer_GetExtraAudioVolume_TYPE FCriWareApi::criManaPlayer_GetExtraAudioVolume = ::criManaPlayer_GetExtraAudioVolume;
criManaPlayer_SetPan_TYPE FCriWareApi::criManaPlayer_SetPan = ::criManaPlayer_SetPan;
criManaPlayer_GetPan_TYPE FCriWareApi::criManaPlayer_GetPan = ::criManaPlayer_GetPan;
criManaPlayer_ResetSendLevel_TYPE FCriWareApi::criManaPlayer_ResetSendLevel = ::criManaPlayer_ResetSendLevel;
criManaPlayer_SetSendLevel_TYPE FCriWareApi::criManaPlayer_SetSendLevel = ::criManaPlayer_SetSendLevel;
criManaPlayer_ResetSubAudioSendLevel_TYPE FCriWareApi::criManaPlayer_ResetSubAudioSendLevel = ::criManaPlayer_ResetSubAudioSendLevel;
criManaPlayer_SetSubAudioSendLevel_TYPE FCriWareApi::criManaPlayer_SetSubAudioSendLevel = ::criManaPlayer_SetSubAudioSendLevel;
criManaPlayer_ResetExtraAudioSendLevel_TYPE FCriWareApi::criManaPlayer_ResetExtraAudioSendLevel = ::criManaPlayer_ResetExtraAudioSendLevel;
criManaPlayer_SetExtraAudioSendLevel_TYPE FCriWareApi::criManaPlayer_SetExtraAudioSendLevel = ::criManaPlayer_SetExtraAudioSendLevel;
criManaPlayer_SetBusSendLevelByName_TYPE FCriWareApi::criManaPlayer_SetBusSendLevelByName = ::criManaPlayer_SetBusSendLevelByName;
criManaPlayer_SetSubAudioBusSendLevelByName_TYPE FCriWareApi::criManaPlayer_SetSubAudioBusSendLevelByName = ::criManaPlayer_SetSubAudioBusSendLevelByName;
criManaPlayer_SetExtraAudioBusSendLevelByName_TYPE FCriWareApi::criManaPlayer_SetExtraAudioBusSendLevelByName = ::criManaPlayer_SetExtraAudioBusSendLevelByName;
criManaPlayer_ResetBusSendLevelAll_TYPE FCriWareApi::criManaPlayer_ResetBusSendLevelAll = ::criManaPlayer_ResetBusSendLevelAll;
criManaPlayer_ReferFrame_TYPE FCriWareApi::criManaPlayer_ReferFrame = ::criManaPlayer_ReferFrame;
criManaPlayer_IsFrameOnTime_TYPE FCriWareApi::criManaPlayer_IsFrameOnTime = ::criManaPlayer_IsFrameOnTime;
criManaPlayer_KeepFrame_TYPE FCriWareApi::criManaPlayer_KeepFrame = ::criManaPlayer_KeepFrame;
criManaPlayer_GetNumberOfKeepFrames_TYPE FCriWareApi::criManaPlayer_GetNumberOfKeepFrames = ::criManaPlayer_GetNumberOfKeepFrames;
criManaPlayer_CopyFrameToBufferARGB32_TYPE FCriWareApi::criManaPlayer_CopyFrameToBufferARGB32 = ::criManaPlayer_CopyFrameToBufferARGB32;
criManaPlayer_CopyFrameToBuffersYUV_TYPE FCriWareApi::criManaPlayer_CopyFrameToBuffersYUV = ::criManaPlayer_CopyFrameToBuffersYUV;
criManaPlayer_DiscardFrame_TYPE FCriWareApi::criManaPlayer_DiscardFrame = ::criManaPlayer_DiscardFrame;
criManaPlayer_DiscardOneKeepFrame_TYPE FCriWareApi::criManaPlayer_DiscardOneKeepFrame = ::criManaPlayer_DiscardOneKeepFrame;
criManaPlayer_SetDataRequestCallback_TYPE FCriWareApi::criManaPlayer_SetDataRequestCallback = ::criManaPlayer_SetDataRequestCallback;
criManaPlayer_DeferCallback_TYPE FCriWareApi::criManaPlayer_DeferCallback = ::criManaPlayer_DeferCallback;
criManaPlayer_SetSeekPosition_TYPE FCriWareApi::criManaPlayer_SetSeekPosition = ::criManaPlayer_SetSeekPosition;
criManaPlayer_SetMovieEventSyncMode_TYPE FCriWareApi::criManaPlayer_SetMovieEventSyncMode = ::criManaPlayer_SetMovieEventSyncMode;
criManaPlayer_SetSubtitleChannel_TYPE FCriWareApi::criManaPlayer_SetSubtitleChannel = ::criManaPlayer_SetSubtitleChannel;
criManaPlayer_GetSubtitleOnTime_TYPE FCriWareApi::criManaPlayer_GetSubtitleOnTime = ::criManaPlayer_GetSubtitleOnTime;
criManaPlayer_GetCuePointInfo_TYPE FCriWareApi::criManaPlayer_GetCuePointInfo = ::criManaPlayer_GetCuePointInfo;
criManaPlayer_SetCuePointCallback_TYPE FCriWareApi::criManaPlayer_SetCuePointCallback = ::criManaPlayer_SetCuePointCallback;
criManaPlayer_CalcFrameNoFromTime_TYPE FCriWareApi::criManaPlayer_CalcFrameNoFromTime = ::criManaPlayer_CalcFrameNoFromTime;
criManaPlayer_CalcTimeFromFrameNo_TYPE FCriWareApi::criManaPlayer_CalcTimeFromFrameNo = ::criManaPlayer_CalcTimeFromFrameNo;
criManaPlayer_SearchNextEventPointByTime_TYPE FCriWareApi::criManaPlayer_SearchNextEventPointByTime = ::criManaPlayer_SearchNextEventPointByTime;
criManaPlayer_SearchPrevEventPointByTime_TYPE FCriWareApi::criManaPlayer_SearchPrevEventPointByTime = ::criManaPlayer_SearchPrevEventPointByTime;
criManaPlayer_SetSpeed_TYPE FCriWareApi::criManaPlayer_SetSpeed = ::criManaPlayer_SetSpeed;
criManaPlayer_SetDecodeMode_TYPE FCriWareApi::criManaPlayer_SetDecodeMode = ::criManaPlayer_SetDecodeMode;
criManaDecrypter_CalculateWorkSize_TYPE FCriWareApi::criManaDecrypter_CalculateWorkSize = ::criManaDecrypter_CalculateWorkSize;
criManaDecrypter_Create_TYPE FCriWareApi::criManaDecrypter_Create = ::criManaDecrypter_Create;
criManaDecrypter_Destroy_TYPE FCriWareApi::criManaDecrypter_Destroy = ::criManaDecrypter_Destroy;
criManaPlayer_CalculateExtDecoderWorkSize_TYPE FCriWareApi::criManaPlayer_CalculateExtDecoderWorkSize = ::criManaPlayer_CalculateExtDecoderWorkSize;
criManaPlayer_SetExtDecoderWork_TYPE FCriWareApi::criManaPlayer_SetExtDecoderWork = ::criManaPlayer_SetExtDecoderWork;
criManaPlayer_SetExtDecoderWorkAllocator_TYPE FCriWareApi::criManaPlayer_SetExtDecoderWorkAllocator = ::criManaPlayer_SetExtDecoderWorkAllocator;
criManaPlayer_SetSoundCategoryByName_TYPE FCriWareApi::criManaPlayer_SetSoundCategoryByName = ::criManaPlayer_SetSoundCategoryByName;
criManaPlayer_UnsetSoundCategory_TYPE FCriWareApi::criManaPlayer_UnsetSoundCategory = ::criManaPlayer_UnsetSoundCategory;
criManaPlayer_SetNumberOfFramesForPrep_TYPE FCriWareApi::criManaPlayer_SetNumberOfFramesForPrep = ::criManaPlayer_SetNumberOfFramesForPrep;
criManaPlayer_SetVideoFramerate_TYPE FCriWareApi::criManaPlayer_SetVideoFramerate = ::criManaPlayer_SetVideoFramerate;
criMana_SetIgnoreAudioPrep_TYPE FCriWareApi::criMana_SetIgnoreAudioPrep = ::criMana_SetIgnoreAudioPrep;
criManaPlayer_GetNumberOfSeekBlocks_TYPE FCriWareApi::criManaPlayer_GetNumberOfSeekBlocks = ::criManaPlayer_GetNumberOfSeekBlocks;
criManaPlayer_GetSeekBlockInfo_TYPE FCriWareApi::criManaPlayer_GetSeekBlockInfo = ::criManaPlayer_GetSeekBlockInfo;
criManaPlayer_SetBusSendLevel_TYPE FCriWareApi::criManaPlayer_SetBusSendLevel = ::criManaPlayer_SetBusSendLevel;
criManaPlayer_SetSubAudioBusSendLevel_TYPE FCriWareApi::criManaPlayer_SetSubAudioBusSendLevel = ::criManaPlayer_SetSubAudioBusSendLevel;
...
criMana_CalculateVp9DecoderWorkSize_TYPE FCriWareApi::criMana_CalculateVp9DecoderWorkSize = ::criMana_CalculateVp9DecoderWorkSize;
criMana_SetupVp9Decoder_TYPE FCriWareApi::criMana_SetupVp9Decoder = ::criMana_SetupVp9Decoder;
#endif
#ifdef XPT_TGT_MACOSX
criMana_CalculateVideoToolboxH264DecoderWorkSize_MACOSX_TYPE FCriWareApi::criMana_CalculateVideoToolboxH264DecoderWorkSize_MACOSX = ::criMana_CalculateVideoToolboxH264DecoderWorkSize_MACOSX;
criMana_SetupVideoToolboxH264Decoder_MACOSX_TYPE FCriWareApi::criMana_SetupVideoToolboxH264Decoder_MACOSX = ::criMana_SetupVideoToolboxH264Decoder_MACOSX;
#endif
#ifdef XPT_TGT_ANDROID
criMana_SetDecodeThreadPriority_ANDROID_TYPE FCriWareApi::criMana_SetDecodeThreadPriority_ANDROID = ::criMana_SetDecodeThreadPriority_ANDROID;
criMana_SetupJNIMeidiaCodecH264Decoder_ANDROID_TYPE FCriWareApi::criMana_SetupJNIMeidiaCodecH264Decoder_ANDROID = ::criMana_SetupJNIMeidiaCodecH264Decoder_ANDROID;
criMana_CalculateJNIMeidiaCodecH264DecoderWorkSize_ANDROID_TYPE FCriWareApi::criMana_CalculateJNIMeidiaCodecH264DecoderWorkSize_ANDROID = ::criMana_CalculateJNIMeidiaCodecH264DecoderWorkSize_ANDROID;
criManaPlayer_SetGLTextureForJNIMediaCodec_ANDROID_TYPE FCriWareApi::criManaPlayer_SetGLTextureForJNIMediaCodec_ANDROID = ::criManaPlayer_SetGLTextureForJNIMediaCodec_ANDROID;
criManaPlayer_UpdateTextureImageForJNIMediaCodec_ANDROID_TYPE FCriWareApi::criManaPlayer_UpdateTextureImageForJNIMediaCodec_ANDROID = ::criManaPlayer_UpdateTextureImageForJNIMediaCodec_ANDROID;
criManaPlayer_GetTransMatrixForJNIMediaCodec_ANDROID_TYPE FCriWareApi::criManaPlayer_GetTransMatrixForJNIMediaCodec_ANDROID = ::criManaPlayer_GetTransMatrixForJNIMediaCodec_ANDROID;
criManaPlayer_AttachToGLContextForJNIMediaCodec_ANDROID_TYPE FCriWareApi::criManaPlayer_AttachToGLContextForJNIMediaCodec_ANDROID = ::criManaPlayer_AttachToGLContextForJNIMediaCodec_ANDROID;
criManaPlayer_DetachFromGLContextForJNIMediaCodec_ANDROID_TYPE FCriWareApi::criManaPlayer_DetachFromGLContextForJNIMediaCodec_ANDROID = ::criManaPlayer_DetachFromGLContextForJNIMediaCodec_ANDROID;
#endif
